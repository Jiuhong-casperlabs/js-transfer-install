...
const main = async () => {
  ...
  const myHash = new CLAccountHash(
    CLPublicKey.fromHex(public_key).toAccountHash()
  );
  ...
  console.log(
    "dictionary_item_key_for_tokenid is: ",
    dictionary_item_key_for_tokenid
  );

  const value = new CLString(
    "ac74d3d56735f2ebe9bb7f8b08e12baf7dd456711397d0995f5f8c9eddfe71c4"
  );
  const dictionary_item_key_for_index = keyAndValueToHex(key, value);
  console.log(
    "dictionary_item_key_for_index is: ",
    dictionary_item_key_for_index
  );
};
